...
export default function Home() {
  return (
    <>
      ...
      >
        <Hero />
        <section className="relative md:-mt-44">
          <svg
        ...
        <section id="about-section" className="bg-white border-b py-2">
          <div className="container max-w-5xl mx-auto m-8 px-4">
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 sm:mt-1 sm:py-1 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-4">Warm regards,</p>
                  <p className="font-bold text-gray-600">Ilana Friedman</p>
        ...
        <section className="bg-white border-b pt-8">
          <div className="container mx-auto flex flex-wrap pt-4 px-4">
            <h2 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
              Learn More!
            </h2>
            <div className="w-full mb-4">
