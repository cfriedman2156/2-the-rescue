        ...
        <>
            ...
            <main className="leading-normal tracking-normal text-white gradient" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>
                <section className="pt-16 sm:pt-24">
                    <div className="container px-4 sm:px-6 mx-auto flex flex-wrap flex-col items-center md:flex-row md:items-center">
                        ...
                        <div className="w-full md:w-1/2 text-center px-4 sm:px-6 pb-6">
                            <h1 className="my-4 text-2xl sm:text-4xl md:text-5xl font-bold leading-tight">Visit 2 The Rescue Animal Sanctuary!</h1>
                        </div>
                    </div>
