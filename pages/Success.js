    ...
    return (
        <>
            ...
            <main className="gradient text-white">
                <section className="pt-32">
                    <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                        <div className="w-full flex flex-wrap justify-center">
                            <img src="./images/sally.webp" className="h-80 rounded-l-3xl" />
                            <img src="./images/tucker.webp" className="h-80 rounded-r-3xl" />
                        </div>
                        <div className=" w-full text-center">
                            <h1 className="my-4 text-5xl font-bold leading-tight text-center">Thank you for your donation!</h1>
                            <p className="text-2xl">A receipt has been sent to your email</p>
                ...
                <section className="pt-10 relative -mt-12 lg:-mt-24">
