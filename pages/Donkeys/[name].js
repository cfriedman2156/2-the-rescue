...
export default function DonkeyDetail() {
            ...
            <main className="leading-normal tracking-normal text-white gradient" style={{ fontFamily: "'Source Sans Pro', sans-serif" }}>         
                ...
                <div className="container mx-auto px-4">
                    <div className='flex mt-12 flex-wrap'>
                        {/* <img src={donkey.profileImage} alt={donkey.name} className="w-1/3 rounded-xl mb-4" /> */}
                        <div className='px-6 '>
                            <h1 className="text-6xl font-bold text-center">{donkey.name}</h1>
                            <div className='py-5 px-40 text-2xl'>
                                <p className='my-2 font-bold'>Age: {donkey.age}</p>
                ...
                {/* <div className="pt-4 bg-white">
                    {donkey.photos && donkey.photos.length > 0 && (
                        <>
                            <h2 className="text-4xl text-black text-center font-bold mb-2">Photos</h2>
                            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">

                                {donkey.photos.map((photo, index) => (
                                    <img key={index} src={photo} alt={`${donkey.name} photo ${index + 1}`} className="w-full rounded-xl" />
                                ))}
                            </div>
                        </>
                    )}
