    ...
    return (
        <nav id="header" className="fixed w-full z-40 top-0 text-white">
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-1">
                ...
                <div className={`w-full flex-grow lg:flex lg:items-center lg:w-auto ${navOpen ? '' : 'hidden'} mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20`} id="nav-content">
                    <ul className="list-reset lg:flex justify-end flex-1 items-center">
                        ...
                        <div className="dropdown dropdown-hover">
                            <li className="mr-3">
                                <div role="button" className="inline-block m-1 text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" onClick={redirectToDifference} onMouseOver={handleDropdownClick}>
                                    Make a Difference
                                </div>
                                <ul tabIndex={0} className="menu dropdown-content z-[1] p-2 shadow bg-base-100 rounded-box w-52">
