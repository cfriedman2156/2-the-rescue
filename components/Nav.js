            ...
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-1">
                ...
                <div className={`w-full rounded-2xl mx-4 flex-grow lg:flex lg:items-center lg:w-auto ${navOpen ? '' : 'hidden'} mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20`} id="nav-content">
                    <ul className="list-reset lg:flex justify-end flex-1 items-center">
                        ...
                        <li className="mr-3">
                            <div className="dropdown dropdown-hover">
                                <div role="button" className="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" onClick={redirectToVisit} onMouseOver={handleDropdownClick}>
                                    Visit Us
                                </div>
                                <ul tabIndex={0} className="menu dropdown-content z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                    <li><a href="/Visit">Schedule a Visit</a></li>
                                    <li><a href="/Schedule-Event">Book an Event</a></li>
                                    <li><a href="https://www.hipcamp.com/en-US/land/california-2-the-rescue-animal-sanctuary-88lhoonx?adults=1&children=0&srid=5a414ddd-b488-46bf-9a47-924d34ddc4c1" target='_blank'>Stay the Night</a></li>
                                </ul>
                            </div>
                        </li>
                        <li className="mr-3">
