export const quiz = {
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ['Aries', 'Taurus', 'Gemini', 'Cancer', 'Leo', 'Virgo', 'Libra', 'Scorpio', 'Sagittarius', 'Capricorn', 'Aquarius', 'Pisces'],
            answersPoints: [],
        },
        {
            id: 6,
            question: 'What is your spirit animal?',
            answers: ['Wolf', 'Eagle', 'Bear', 'Capybara', 'Shiba Inu', 'Lion', 'Elephant'],
            answersPoints: [],
        },
        {
            id: 7,
        ...
        },
        {
            ...
            answers: ['Fuuny', 'Loyal', 'Ambitious', 'Creative', 'Honest'],
            answersPoints: [],
        },
        {
            id: 10,
